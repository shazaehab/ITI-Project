...
<body>
    ...
    <div class="humberger__menu__wrapper">
        <div class="humberger__menu__logo">
            <a href="#"><img src="img/loll.jpg" alt=""></a>
        </div>
        ...
        <div class="humberger__menu__contact">
            <ul>
                <li><i class="fa fa-envelope"></i> rawan.emadnegm@gmail.com</li>
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="header__logo">
                        <a href="./index.php"><img src="img/loll.jpg" alt=""></a>
                    </div>
                </div>
                <div class="col-lg-6">
