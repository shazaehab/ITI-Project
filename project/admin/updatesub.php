...
$sub_data=$sub_categories->select_one($id);
...
if(isset($_POST['add'])){
    ...
    if(in_array($extension,$allowd_extensions)){
        $sub_categories->set_image($image_name);
        move_uploaded_file($image_tmp,"..\img\\$image_name");
        $sub_categories->insert();
    }
    else{
        $image_name=$sub_data['sub_image'];
    }
                                                ...
                                                <div class="all-form-element-inner">
                                                    <form method="post" enctype="multipart/form-data">
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                <div class="col-lg-3">
                                                                    <label class="login2 pull-right pull-right-pro">sub_categories</label>
                                                                </div>
                                                                <div class="col-lg-9">
